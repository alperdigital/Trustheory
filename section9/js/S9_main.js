(function(){
  ...
  window.S9_mount=function(){ if(mounted) return; var root=document.getElementById('s9-root'); if(!root){ console.error('s9-root yok'); return; } root.hidden=false; try{ root.classList.add('s9-sketch'); /* add 's9-mobile-offset' externally if needed */ }catch(e){}
    root.innerHTML=''+
      '<div class="s9-intro">'+
